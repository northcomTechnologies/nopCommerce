...
namespace Nop.Plugin.Payments.CheckMoneyOrder
{
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public async Task<bool> HidePaymentMethodAsync(IList<ShoppingCartItem> cart)
        {
            ...
            // Λήψη του πελάτη (customer) από το πλαίσιο της τρέχουσας συνεδρίας
            //var customer = await _workContext.GetCurrentCustomerAsync();

            //// Λήψη του επιλεγμένου τρόπου αποστολής για τον πελάτη
            //var shippingOption = await _genericAttributeService.GetAttributeAsync<ShippingOption>(customer, NopCustomerDefaults.SelectedShippingOptionAttribute,1);

            //if (shippingOption != null)
            //{
            //    if (shippingOption.Name == "BoxNow")
            //        return true;
            //}
